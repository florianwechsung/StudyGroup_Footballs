...
\left(\begin{array}{c}
 \ddot{x}\\
\ddot{y}\\
\ddot{z}\end{array} \right) = -g\left(\begin{array}{c}
 0\\
0\\
1\end{array} \right) - \frac{F_{d}}{m\sqrt{(x^2+y^2+z^2)}} \left(\begin{array}{c}
 \dot{x}\\
\dot{y}\\
\dot{z}\end{array} \right) + \frac{F_m}{m}  \left(\begin{array}{c}
 \\
\underline{s}\\
\hphantom{0}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{1-1.png}
...
\end{figure}
 ...
 \frametitle{3D plots}
  \begin{figure}
\centering
\includegraphics[scale=.4]{3d1.eps}
\caption{Spiral projection}
\end{figure}
 \end{frame}
 ...
 \begin{frame}
  \begin{figure}
\centering
\includegraphics[scale=.4]{3d2.eps}
\caption{Drag crisis}
\end{figure}
 \end{frame}
...
\begin{figure}[h]
\centering
\includegraphics[scale=.5]{dragcrisis.eps}
\caption{Drag crisis}
\end{figure}
\end{frame}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.3]{original.png}
\caption{Drag crisis}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[scale=.5]{comparision_2d.eps}
\caption{Comparison of drag crisis effect}
\end{figure}
\end{frame}
